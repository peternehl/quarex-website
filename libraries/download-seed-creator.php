...
<body>
    <div class="container">
        ...
        <div class="instructions">
            <h2>Instructions</h2>
            <ul>
                <li>This tool creates a Quarex "seed" - a JSON structure that defines a new book for the TruthAngel library.</li>
        ...
        <form id="seedForm">
            ...
            <div class="button-group">
                ...
                <button type="button" class="btn-secondary" onclick="window.open('https://truthangel.org/template-files/quarex-seed-instructions.html', '_blank')">View Seed Instructions</button>
            </div>
        </form>
        ...
        <footer>
            <p>
                Quarex Seed Creator by <a href="https://truthangel.org" class="quarex-link">TruthAngel.org</a><br>
                For Quarex creation instructions, see: <a href="https://truthangel.org/template-files/quarex-seed-instructions.html" class="quarex-link">Quarex Creation Guide</a>
            </p>
        </footer>
    </div>
